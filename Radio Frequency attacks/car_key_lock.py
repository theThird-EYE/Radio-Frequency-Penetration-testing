...
class car_key_frequency(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "car_key_frequency")
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/loki/id_card', False)
...
def main(top_block_cls=car_key_frequency, options=None):
